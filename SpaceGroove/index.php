			...
			<div class="container">
				<div class="row text-center">
					<div class="col-md-8">
						...
						<h1 class="white-text">The natural world does not end at the Earth's stratosphere.</h1>
		...
		<section id="about">
			<div class="container">
				<div class="embed-responsive embed-responsive-16by9">
					<iframe class="embed-responsive-item" src="https://mars.nasa.gov/mars2020/multimedia/videos/?v=456"></iframe>
				</div>
			</div>			
		</section>
	<!-- ABOUT ENDS -->
