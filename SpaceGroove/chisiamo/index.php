		...
		<div class="container ">
			<div class="row">
				...
				<div class="col-xs-12 mb-4 heading-title text-center">
					<h3>OUR TEAM</h3>
					<p>1. This site was created for our Web Languages and Technologies' project<br>
						2. We love space! So we wanted to celebrate NASA's Mars 2020 mission and Perseverance rover with a web site to learn about our Solar System.</p>
				</div>
				...
				<div class="row col-xs-12">
					<div class="col-lg-6 mb-4">
						<div class="row">
							...
							<div class="col-md-12 text-center">
							  <div class="pt-2">
								<h6 class="mt-4 font-weight-medium mb-0">Marzia Moscatelli</h6>
					...
					<div class="col-lg-6 mb-4">
						<div class="row">
							...
							<div class="col-md-12 text-center">
							  <div class="pt-2">
								<h6 class="mt-4 font-weight-medium mb-0">Alessandro Nicolella</h6>
								<h5 class="subtitle mb-3">Student in Computer and System Engineering</h5>
