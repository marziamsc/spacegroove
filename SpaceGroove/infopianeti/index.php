...
<body>
	...
	<div class="login-dark">
        <span>
            <h6>Here you can find out a lot of information!</h6><br>
			<div class="form-group">
				...
				<select class="form-control" id="info" name="info">
					<option value="" disabled selected>What do you want to know❓</option>
				...
				<button class="btn-primary" id="ask" type="submit"><h6>Ask</h6></button>
				<button class="btn-primary" id="reset" type="reset"><h6>Reset</h6></button>
			</div>
		</span> 
	...
	$(document).ready(function() {
    	$('#ask').click(function() {
    		...
    		$.ajax({
            	...
            	error: function(){
            		var msg = "Error";
					$("#zona_din").html('<h3 style="color: red">'+msg+'</h3>');
            	}
    		});
