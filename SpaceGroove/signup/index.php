	...
	<div class="login-dark">
        <form action="registration.php" method="POST" name="signup" onSubmit="return validaForm();">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="tel" placeholder="Number" size="16" maxlength="16" onChange="return controllaNumero();">
				...
				<button class="btn-primary" name="registrationButton" type="submit">Register</button>
