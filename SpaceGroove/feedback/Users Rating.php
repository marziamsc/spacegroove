<html> 
    ...
    <body> 
        ...
        <div class="row">
            ...
            <div class="middle">
                <div class="progress">
                    <div class="progress-bar progress-bar-warning progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo $su100; ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $su100; ?>%">
                    </div>
                </div>
            </div>   
